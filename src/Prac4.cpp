...
void play_pause_isr(void)
{
    //Write your logis here
     ...
     if ( interrupt_time - lastInterruptTime > 20 )
     {playing = !playing ;}
}
...
void *playThread(void *threadargs){
    ...
    {
	//reading from buffer
        char val1=buffer[bufferReading][buffer_location][0];
	char val2=buffer[bufferReading][buffer_location][1];  
	 ...
	 while((ch = fgetc(filePointer)) != EOF)
         {
              ...
              buffer[bufferWriting][counter][0] =(ch>>4) & 00011111 ; //TODO
              //Set next 8 bit packet
              buffer[bufferWriting][counter][1] =(ch<<4) & 11111111 ; //TODO
